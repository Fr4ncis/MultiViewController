...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    NSMutableArray *controllers = [[NSMutableArray alloc] initWithCapacity:100];
    for (int i = 0; i < 100; i++)
    {
        ColoredViewController *vc = [[ColoredViewController alloc] initWithBackgroundColor:[UIColor randomColor]];
